...
export async function buildMotorProject({client, name, projectDirectory, backupPath, deviceName='PLC_1', orderNumber=defaultOrderNumber, call}) {
  ...
  await call('tia_apply_scl',{project:activeProjectPath||`${projectDirectory}\\${name}.ap20`,deviceName,sourceName:'Motor_Starter_FB_DB_Source',filePath:`${projectDirectory}\\${name}_Motor_Starter_FB_DB.scl`,content:fbSource,overwrite:true});
