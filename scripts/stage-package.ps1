...
Copy-Item -LiteralPath (Join-Path $root 'docs\validation.md'),(Join-Path $root 'docs\roadmap.md'),(Join-Path $root 'docs\first-connection.md'),(Join-Path $root 'docs\requirements-matrix.md'),(Join-Path $root 'docs\BEGINNER-GUIDE.md'),(Join-Path $root 'docs\USER-INSTALL-GUIDE.md'),(Join-Path $root 'docs\AUTO-INSTALL-DESIGN.md'),(Join-Path $root 'docs\full-flow-test-20260829.md'),(Join-Path $root 'docs\FINAL-TEST-REPORT.md'),(Join-Path $root 'docs\OPEN-SOURCE-AGENT-PATTERNS.md'),(Join-Path $root 'docs\ISOLATED-ENVIRONMENT-TEST-PLAN.md') -Destination (Join-Path $dist 'docs')
