...
$allow=@('chat','runtime','docs','scripts','start-agent.ps1','start-agent.cmd','install-agent.ps1','mcp.example.json','THIRD-PARTY-SOURCES.txt','MANIFEST.sha256.json','README.md','TiaV20Agent.exe')
